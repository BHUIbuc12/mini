<template>
  <div :style="{backgroundImage:`url(${imgSrc})`}" class="login-container">
    <el-form
      ref="loginForm"
      :model="loginForm"
      :rules="loginRules"
    ...
    >
      ...
      <el-button :loading="loading" class="login-btn" type="primary" @click.native.prevent="handleLogin">Login
      </el-button>
