  ...
  <div>
    <el-card class="container-card" shadow="always">
      ...
      >
        ...
        <el-table-column label="用户名" prop="username" show-overflow-tooltip sortable />
        <el-table-column label="昵称" prop="nickname" show-overflow-tooltip sortable />
        <el-table-column align="center" label="状态" prop="status" show-overflow-tooltip sortable>
        ...
        <el-table-column label="手机号" prop="mobile" show-overflow-tooltip sortable />
        <el-table-column label="创建人" prop="creator" show-overflow-tooltip sortable />
        <el-table-column label="说明" prop="introduction" show-overflow-tooltip sortable />
