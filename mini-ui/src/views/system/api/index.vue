  ...
  <div>
    <el-card class="container-card" shadow="always">
      ...
      >
        ...
        <el-table-column label="访问路径" prop="path" show-overflow-tooltip sortable />
        <el-table-column label="所属类别" prop="category" show-overflow-tooltip sortable />
        <el-table-column align="center" label="请求方式" prop="method" show-overflow-tooltip sortable>
          <template slot-scope="scope">
            <el-tag :type="scope.row.method | methodTagFilter" disable-transitions size="small">{{
              scope.row.method
            }}
            </el-tag>
          </template>
      ...
      <el-dialog :title="dialogFormTitle" :visible.sync="dialogFormVisible">
        <el-form ref="dialogForm" :model="dialogFormData" :rules="dialogFormRules" label-width="120px" size="small">
