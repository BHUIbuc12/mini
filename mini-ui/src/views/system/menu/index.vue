  ...
  <div>
    <el-card class="container-card" shadow="always">
      ...
      >
        ...
        <el-table-column label="菜单标题" prop="title" show-overflow-tooltip width="150" />
        ...
        <el-table-column align="center" label="禁用" prop="status" show-overflow-tooltip width="80">
        ...
        <el-table-column align="center" label="隐藏" prop="hidden" show-overflow-tooltip width="80">
          <template slot-scope="scope">
            <el-tag :type="scope.row.hidden === 1 ? 'danger':'success'" size="small">
              {{ scope.row.hidden === 1 ? '是' : '否' }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column align="center" label="缓存" prop="noCache" show-overflow-tooltip width="80">
          <template slot-scope="scope">
            <el-tag :type="scope.row.noCache === 1 ? 'danger':'success'" size="small">
              {{ scope.row.noCache === 1 ? '否' : '是' }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column label="高亮菜单" prop="activeMenu" show-overflow-tooltip />
        ...
        >
          ...
          <el-form-item label="图标" prop="icon">
            ...
            >
              ...
              >
                <svg-icon
                  v-if="dialogFormData.icon"
                  slot="prefix"
                  :icon-class="dialogFormData.icon"
